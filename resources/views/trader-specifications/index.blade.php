...
@section('title', 'Trader Design Specification Master')
        ...
        <div class="page-title-area">
            ...
            <div>
                ...
                <p class="page-subtitle mb-0">
                    Manage trader products, buying details & specifications
                </p>
            </div>
    ...
    <div
        ...
        <div class="section-header">
            ...
            <p
                ...
                Build a trader product profile with purchase intelligence
            </p>
            ...
            <div class="inner-card mb-4">
                ...
                <div class="inner-card-header">
                    ...
                    <div>
                        ...
                        <small>
                            Upload the main product images and sub images.
                        </small>
                    </div>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($itemNames as $itemName)
                                    ...
                                    <option value="{{ $itemName->id }}" data-code="{{ $itemName->code ?? '' }}">
                                        {{ $itemName->itemname }}
                                        @if(!empty($itemName->code)) ({{ $itemName->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($itemTypes as $itemType)
                                    ...
                                    <option value="{{ $itemType->id }}" data-code="{{ $itemType->code ?? '' }}">
                                        {{ $itemType->itemtype }}
                                        @if(!empty($itemType->code)) ({{ $itemType->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($designers as $designer)
                                    ...
                                    <option value="{{ $designer->id }}" data-code="{{ $designer->code ?? '' }}">
                                        {{ $designer->designername }}
                                        @if(!empty($designer->code)) ({{ $designer->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($genders as $gender)
                                    ...
                                    <option value="{{ $gender->id }}" data-code="{{ $gender->code ?? '' }}">
                                        {{ $gender->name }}
                                        @if(!empty($gender->code)) ({{ $gender->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($compositions as $composition)
                                    ...
                                    <option value="{{ $composition->id }}" data-code="{{ $composition->code ?? '' }}">
                                        {{ $composition->composition_details }}
                                        @if(!empty($composition->code)) ({{ $composition->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($yarns as $yarn)
                                    ...
                                    <option value="{{ $yarn->id }}" data-master-id="{{ $yarn->id }}" data-code="{{ $yarn->code ?? '' }}">
                                        {{ $yarn->yarnname }}
                                        @if(!empty($yarn->code)) ({{ $yarn->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($colours as $colour)
                                    ...
                                    <option value="{{ $colour->id }}" data-code="{{ $colour->code ?? '' }}">
                                        {{ $colour->colourname }}
                                        @if(!empty($colour->code)) ({{ $colour->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($sizes as $size)
                                    ...
                                    <option value="{{ $size->id }}" data-code="{{ $size->code ?? '' }}">
                                        {{ $size->size }}
                                        @if(!empty($size->code)) ({{ $size->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($embellishments as $embellishment)
                                    ...
                                    <option value="{{ $embellishment->id }}" data-code="{{ $embellishment->code ?? '' }}">
                                        {{ $embellishment->embellishmentname }}
                                        @if(!empty($embellishment->code)) ({{ $embellishment->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach(
                                    ...
                                    <option value="{{ $process->id }}" data-code="{{ $process->code ?? '' }}">
                                        {{ $process->manufacturing_process }}
                                        @if(!empty($process->code)) ({{ $process->code }}) @endif
                                    </option>
                        ...
                        <div class="input-with-add">
                            ...
                            <select
                                ...
                                @foreach($manufactures as $manufacture)
                                    ...
                                    <option value="{{ $manufacture->id }}" data-code="{{ $manufacture->code ?? '' }}">
                                        {{ $manufacture->name }}
                                        @if(!empty($manufacture->code)) ({{ $manufacture->code }}) @endif
                                    </option>
                            ...
                            <select
                                ...
                                @foreach($clients as $client)
                                    ...
                                    <option value="{{ $client->id }}" data-code="{{ $client->code ?? '' }}">
                                        {{ $client->name }}
                                        @if(!empty($client->code)) ({{ $client->code }}) @endif
                                    </option>
...
{{-- =========================================================
     TRADER BUYING INFORMATION
========================================================= --}}
<div class="trader-buying-panel mt-4" id="traderBuyingInformation">

    <div class="trader-panel-head">
        <div class="trader-panel-brand">
            <div class="trader-panel-icon">
                <i class="bi bi-shop-window"></i>
            </div>
            <div>
                <div class="trader-kicker">COMMERCIAL PROFILE</div>
                <h5>Trader Buying Information</h5>
                <p>Capture the commercial side of this product separately from its design specification.</p>
            </div>
        </div>
        <div class="trader-panel-tag">
    ...
    <div class="trader-panel-body">
        ...
        <div class="trader-subsection">
            <div class="trader-subsection-title">
                <span class="trader-step">01</span>
                <div>
                    <strong>Supplier &amp; Purchase</strong>
                    <small>Who you bought it from and purchase reference</small>
                </div>
            </div>

            <div class="trader-fields">
                <div class="form-field trader-field-emphasis">
                    <label class="form-label">Trader / Buying From <span class="required">*</span></label>
                    <select class="form-select select2-master" id="trader_id" name="trader_id">
    ...
    @endforeach
                ...
                <div class="form-field">
                    <label class="form-label">Trader SKU</label>
                    <input type="text" id="trader_sku" name="trader_sku" class="form-control" placeholder="Trader product SKU">
                </div>
                <div class="form-field">
                    <label class="form-label">Purchase / Bill No.</label>
                    <input type="text" id="purchase_bill_no" name="purchase_bill_no" class="form-control" placeholder="Invoice or bill number">
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    <label class="form-label">Trader Reference</label>
                    <input type="text" id="trader_reference" name="trader_reference" class="form-control" placeholder="Trader reference">
                </div>
                <div class="form-field trader-field-wide">
                    <label class="form-label">Trader Notes</label>
                    <textarea id="trader_notes" name="trader_notes" class="form-control" rows="2" placeholder="Trader buying notes"></textarea>
                </div>
            </div>
        </div>

        <div class="trader-subsection trader-pricing-zone">
            <div class="trader-subsection-title">
                <span class="trader-step">02</span>
                <div>
                    <strong>Quantity &amp; Pricing</strong>
                    <small>Define quantity, buying cost and selling targets</small>
                </div>
            </div>

            <div class="trader-fields trader-price-grid">
                <div class="trader-metric">
                    <label>Quantity <span class="required">*</span></label>
                    <div class="metric-input">
                        <input type="number" step="0.01" min="0.01" id="trader_quantity" name="trader_quantity" placeholder="0">
                        <span>PCS</span>
                    </div>
                </div>
                <div class="trader-metric trader-metric-primary">
                    <label>Buying Price <span class="required">*</span></label>
                    <div class="metric-input">
                        <span>₹</span>
                        <input type="number" step="0.01" min="0" id="trader_buying_price" name="trader_buying_price" placeholder="0.00">
                    </div>
                </div>
                <div class="trader-metric">
                    ...
                    <div class="metric-input">
                        <span>₹</span>
                        <input type="number" step="0.01" min="0" id="trader_selling_price" name="trader_selling_price" placeholder="0.00">
                    </div>
                </div>
                <div class="trader-metric">
                    <label>MRP</label>
                    <div class="metric-input">
                        <span>₹</span>
                        <input type="number" step="0.01" min="0" id="trader_mrp" name="trader_mrp" placeholder="0.00">
                    </div>
                </div>
                <div class="trader-metric">
                    ...
                    <div class="metric-input">
                        <span>₹</span>
                        <input type="number" step="0.01" min="0" id="trader_min_selling_price" name="trader_min_selling_price" placeholder="0.00">
                    </div>
                </div>
                <div class="trader-metric">
                    <label>GST</label>
                    <div class="metric-input">
                        <input type="number" step="0.01" min="0" max="100" id="trader_gst_percent" name="trader_gst_percent" placeholder="0.00">
                        <span>%</span>
                    </div>
                </div>
                <div class="trader-metric">
                    ...
                    <div class="metric-input">
                        <input type="number" step="0.01" min="0" id="trader_discount" name="trader_discount" placeholder="0.00">
                        <span>%</span>
                    </div>
                </div>
            </div>
    ...
    <div
        ...
        <div
            ...
            <h6>
                No trader specifications found
            </h6>

            <p>
                Create your first trader product specification.
            </p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- TRADER BUYING INFORMATION -->
                <div class="confirm-section trader-confirm-section">
                    ...
                    <div class="confirm-grid">
                        <div class="confirm-field">
                            <span>Trader / Buying From</span>
                            <strong id="confirmTraderName">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Trader ID</span>
                            <strong id="confirmTraderId">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Trader SKU</span>
                            <strong id="confirmTraderSku">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Purchase / Bill No.</span>
                            <strong id="confirmPurchaseBillNo">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Purchase Date</span>
                            <strong id="confirmPurchaseDate">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Quantity</span>
                            <strong id="confirmTraderQuantity">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Buying Price</span>
                            <strong id="confirmTraderBuyingPrice">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Selling Price</span>
                            <strong id="confirmTraderSellingPrice">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>MRP</span>
                            <strong id="confirmTraderMrp">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Minimum Selling Price</span>
                            <strong id="confirmTraderMinSellingPrice">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>GST</span>
                            <strong id="confirmTraderGstPercent">-</strong>
                        </div>

                        <div class="confirm-field">
                            <span>Discount</span>
                            <strong id="confirmTraderDiscount">-</strong>
                        </div>

                        <div class="confirm-field confirm-field-wide">
                            <span>Trader Reference</span>
                            <strong id="confirmTraderReference">-</strong>
                        </div>

                        <div class="confirm-field confirm-field-wide">
                            <span>Trader Notes</span>
                            <strong id="confirmTraderNotes">-</strong>
                        </div>
                    </div>
...
/* ============================================================
   TRADER MASTER — DISTINCTIVE COMMERCIAL VISUAL SYSTEM
   Deliberately different from the Design Specification Master.
============================================================ */
.design-spec-page {
    max-width: 1680px;
}
.design-spec-page .page-header {
    padding: 18px 22px;
    border-radius: 18px;
    background: linear-gradient(135deg,#102a43 0%,#174f5c 55%,#167d72 100%);
    box-shadow: 0 12px 30px rgba(16,42,67,.14);
}
.design-spec-page .page-title,
.design-spec-page .page-subtitle { color:#fff; }
.design-spec-page .page-subtitle { opacity:.78; }
.design-spec-page .page-title-icon {
    width:52px;height:52px;border-radius:15px;
    background:rgba(255,255,255,.14);color:#fff;
    box-shadow:inset 0 0 0 1px rgba(255,255,255,.12);
}
.design-spec-page .page-actions .btn-outline-primary,
.design-spec-page .page-actions .btn-outline-success {
    color:#fff;border-color:rgba(255,255,255,.35);
    background:rgba(255,255,255,.08);
}
.design-spec-page .page-actions .btn-outline-primary:hover,
.design-spec-page .page-actions .btn-outline-success:hover {
    background:#fff;color:#123b4a;
}
.design-spec-page .context-card {
    border:0;border-radius:16px;background:#f3f8f7;
    box-shadow:0 8px 22px rgba(15,61,67,.07);
}
.design-spec-page .context-item { border-color:#d9e8e5; }
...
.trader-buying-panel {
    ...
    border-radius:22px;
    background:#fff;
    box-shadow:0 16px 38px rgba(15,61,67,.10);
}
.trader-buying-panel:before {
...
.trader-panel-head {
    ...
    padding:25px 28px;
    background:linear-gradient(135deg,#f0fdfa,#f8fafc 65%,#fff7ed);
    border-bottom:1px solid #dcebe8;
}
.trader-panel-brand {display:flex;align-items:center;gap:16px;}
.trader-panel-icon {
    width:54px;height:54px;border-radius:16px;
    display:flex;align-items:center;justify-content:center;
    color:#fff;font-size:24px;
    background:linear-gradient(145deg,#0f766e,#0d9488);
    box-shadow:0 9px 18px rgba(15,118,110,.22);
}
.trader-kicker {
    font-size:10px;letter-spacing:.14em;font-weight:800;color:#0f766e;
    margin-bottom:3px;
}
.trader-panel-head h5 {margin:0;color:#123b4a;font-size:20px;font-weight:800;}
.trader-panel-head p {margin:4px 0 0;color:#64748b;font-size:12px;}
.trader-panel-tag {
    white-space:nowrap;padding:9px 13px;border-radius:999px;
    background:#fff;border:1px solid #cde4df;color:#0f766e;
    font-size:12px;font-weight:700;
}
.trader-panel-body {padding:24px 28px 28px;}
.trader-subsection {
    padding:20px;
...
.trader-subsection + .trader-subsection {margin-top:16px;}
.trader-subsection-title {
...
.trader-subsection-title strong {display:block;color:#183b46;font-size:14px;}
.trader-subsection-title small {display:block;color:#7a8a90;font-size:11px;margin-top:2px;}
.trader-fields {
    display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;
}
.trader-field-wide {grid-column:1/-1;}
.trader-field-emphasis .form-control {border-color:#9ddbd2;background:#f5fffd;}
.trader-pricing-zone {background:linear-gradient(180deg,#f7fffd,#fff);}
.trader-price-grid {grid-template-columns:repeat(4,minmax(0,1fr));}
.trader-metric {
    padding:14px;border:1px solid #dfeae8;border-radius:13px;background:#fff;
}
.trader-metric label {
    display:block;margin-bottom:8px;font-size:11px;font-weight:800;
    text-transform:uppercase;letter-spacing:.04em;color:#52676d;
}
.trader-metric-primary {
    border-color:#8ed5ca;
...
.metric-input {
    ...
    height:42px;padding:0 11px;border:1px solid #dbe5e4;
    border-radius:10px;background:#fff;color:#7a8a90;font-weight:700;
}
.metric-input input {
    width:100%;border:0;outline:0;background:transparent;
    color:#172f36;font-weight:700;min-width:0;
}
.metric-input:focus-within {border-color:#0f9d8f;box-shadow:0 0 0 3px rgba(15,157,143,.10);}
.trader-notes-zone {background:#fafafa;}
.trader-notes-zone textarea {min-height:88px;resize:vertical;}

@media(max-width:1100px) {
    .trader-price-grid {grid-template-columns:repeat(2,minmax(0,1fr));}
}
@media(max-width:700px) {
    .design-spec-page .page-header,.trader-panel-head {align-items:flex-start;flex-direction:column;}
    .trader-panel-body {padding:16px;}
    .trader-fields,.trader-price-grid {grid-template-columns:1fr;}
    .trader-field-wide {grid-column:auto;}
    .trader-panel-tag {align-self:flex-start;}
}


/* Trader confirmation modal */
.trader-confirm-section .confirm-field strong {
    white-space: pre-wrap;
    word-break: break-word;
}
#confirmSubImages {
    ...
    */
    ...
    return Swal.fire({
        ...
        */
        ...
        |
        | NEW PRODUCT:
        |   POST -> trader-specifications.store
        ...
        document.addEventListener(
            ...
            function (event) {
                ...
                */
                ...
                const yarn = getMasterId('yarn');

                if (document.getElementById('yarn')?.value && !yarn) {
                    showSpecificationAlertAndFocus(
                        'Invalid Yarn selected. Please select Yarn again.',
                        'yarn'
                    );
                    return;
                }
    ...
    /*
    |--------------------------------------------------------------------------
    | GLOBAL MASTER CODE HELPER
    |--------------------------------------------------------------------------
    | Used by the Save / Update function and confirmation function.
    | Each master select stores the master.id as its value and the master
    | code is stored in the option data-code attribute.
    */
    ...
    function getMasterId(selectId) {
        ...
        // Always use the master record ID, never the displayed name/code.
        const rawId =
            option?.dataset?.masterId ||
            option?.value ||
            '';
            ...
            */
            ...
            try {
                ...
                */
                ...
                // Trader is a MASTER SELECT. Always send its master ID and selected name.
                const traderSelect =
                    document.getElementById('trader_id');

                const traderId =
                    traderSelect?.value || '';

                const traderName =
                    traderSelect?.options?.[traderSelect.selectedIndex]?.textContent?.trim() || '';

                const traderSku =
                    document.getElementById('trader_sku')?.value.trim() || '';
                const purchaseBillNo =
                    document.getElementById('purchase_bill_no')?.value.trim() || '';
                const purchaseDate =
                    document.getElementById('purchase_date')?.value || '';
                const traderQuantity =
                    document.getElementById('trader_quantity')?.value || '';
                const traderBuyingPrice =
                    document.getElementById('trader_buying_price')?.value || '';
                const traderSellingPrice =
                    document.getElementById('trader_selling_price')?.value || '';
                const traderMrp =
                    document.getElementById('trader_mrp')?.value || '';
                const traderMinSellingPrice =
                    document.getElementById('trader_min_selling_price')?.value || '';
                const traderGstPercent =
                    document.getElementById('trader_gst_percent')?.value || '';
                const traderDiscount =
                    document.getElementById('trader_discount')?.value || '';
                const traderReference =
                    document.getElementById('trader_reference')?.value.trim() || '';
                ...
                */
                ...
                if (!traderId) {
                    showSpecificationAlertAndFocus(
                        'Please select Trader / Buying From.',
                        'trader_id'
                    );
                    return;
                }

                if (!traderQuantity || Number(traderQuantity) <= 0) {
                    showSpecificationAlertAndFocus(
                        'Please enter a valid trader quantity.',
                        'trader_quantity'
                    );
                    return;
                }

                if (!traderBuyingPrice || Number(traderBuyingPrice) < 0) {
                    showSpecificationAlertAndFocus(
                        'Please enter a valid trader buying price.',
                        'trader_buying_price'
                    );
                    return;
                }
                ...
                */
                ...
                | MASTER CODES
                |--------------------------------------------------------------------------
                | The selected master value is always its master.id.
                | The code is read from the selected option and sent separately.
                */

                const itemNameCode = getMasterCode('item_name');
                const itemTypeCode = getMasterCode('item_type');
                const designerCode = getMasterCode('designer_name');
                const genderCode = getMasterCode('gender_type');
                const compositionCode = getMasterCode('composition');
                const yarnCode = getMasterCode('yarn');
                const colourCode = getMasterCode('colour');
                const sizeCode = getMasterCode('sizes');
                const embellishmentCode = getMasterCode('embellishment');
                const manufacturingProcessCode = getMasterCode('manufacturing_process');
                const craftsmanCode = getMasterCode('mcraftsman');
                const manufactureCode = getMasterCode('cmbmanufacture');
                const clientCode = getMasterCode('cmbclient');
                ...
                */
                ...
                formData.append('yarn_code', yarnCode);
                ...
                // Yarn must ALWAYS be sent as the numeric master ID.
                const yarnIdForRequest =
                    document.getElementById('yarn')?.value || '';

                if (yarnIdForRequest !== '') {
                    const numericYarnId = Number(yarnIdForRequest);

                    if (!Number.isInteger(numericYarnId) || numericYarnId <= 0) {
                        throw new Error('Invalid Yarn master ID. Please select Yarn again.');
                    }

                    formData.append('yarn', String(numericYarnId));
                } else {
                    formData.append('yarn', '');
                }
                ...
                formData.append('trader_sku', traderSku);

                formData.append('purchase_bill_no', purchaseBillNo);
                formData.append('purchase_date', purchaseDate);

                formData.append('trader_quantity', traderQuantity);
                ...
                /*
                |--------------------------------------------------------------------------
                | Related Buying Information
                |--------------------------------------------------------------------------
                */

                formData.append(
                    'trader_payment_terms',
                    document.getElementById('trader_payment_terms')?.value.trim() || ''
                );

                formData.append(
                    'trader_notes',
                    document.getElementById('trader_notes')?.value.trim() || ''
                );
                ...
                */
                ...
                // SUB IMAGES
                // The input is intentionally cleared after selection so the same
                // file can be selected again. Therefore submit the retained
                // selectedSubImages array instead of relying only on input.files.
                if (typeof selectedSubImages !== 'undefined' && Array.isArray(selectedSubImages)) {
                    ...
                    if (subImages && subImages.files && subImages.files.length > 0) {
                        Array.from(subImages.files).forEach(function (file) {
                            formData.append('sub_images[]', file);
                        });
                    }
                }
                ...
                */
                ...
                requestUrl =
                        "{{ url('/admin/trader-specifications') }}/" +
                        encodeURIComponent(
                            editSpecificationId
                        );
                    ...
                    */
                    ...
                    requestUrl =
                        "{{ route('trader-specifications.store') }}";
    ...
    function prepareSpecificationConfirmation(
        ...
        // Safe confirmation helper: confirmation elements may not exist in every modal/version.
        const setConfirmationText = function (id, value) {
        ...
        */
        ...
        function getMasterDisplay(selectId) {
    ...
    [
        ...
        */
        ...
        setConfirmationText('confirmItemName', itemName);

        setConfirmationText('confirmItemName2', itemName);

        setConfirmationText('confirmItemType', itemType);

        setConfirmationText('confirmDesigner', designer);

        setConfirmationText('confirmGender', gender);

        setConfirmationText('confirmComposition', composition);

        setConfirmationText('confirmYarn', yarn);

        setConfirmationText('confirmColour', colour);

        setConfirmationText('confirmSize', size);

        setConfirmationText('confirmEmbellishment', embellishment);

        setConfirmationText('confirmManufacturingProcess', manufacturingProcess);

        setConfirmationText('confirmCraftsman', craftsman);

        setConfirmationText('confirmCraftsmanCode', craftsmanCode);

        setConfirmationText('confirmManufacture', manufacture);

        setConfirmationText('confirmClient', client);

        setConfirmationText('confirmSku', sku);

        setConfirmationText('confirmClientReference', clientReference);
        ...
        */
        ...
        setConfirmationText('confirmTraderName', traderName);
        setConfirmationText('confirmTraderId', traderId);
        setConfirmationText('confirmTraderSku', traderSku);
        setConfirmationText('confirmPurchaseBillNo', purchaseBillNo);
        setConfirmationText('confirmPurchaseDate', purchaseDate);
        setConfirmationText('confirmTraderQuantity', traderQuantity);
        setConfirmationText('confirmTraderBuyingPrice', traderBuyingPrice);
        setConfirmationText('confirmTraderSellingPrice', traderSellingPrice);
        setConfirmationText('confirmTraderMrp', traderMrp);
        setConfirmationText('confirmTraderMinSellingPrice', traderMinSellingPrice);
        setConfirmationText('confirmTraderGstPercent', traderGstPercent);
        setConfirmationText('confirmTraderDiscount', traderDiscount);
        setConfirmationText('confirmTraderReference', traderReference);
        setConfirmationText('confirmTraderNotes', traderNotes);
    ...
    if (barcodeElement) {
        barcodeElement.textContent = existingBarcode;
    }

    if (typeof renderConfirmationBarcode === 'function') {
        renderConfirmationBarcode(existingBarcode);
    }

} else {

    if (barcodeElement) {
        barcodeElement.textContent = generatedBarcode;
    }

    if (typeof renderConfirmationBarcode === 'function') {
        renderConfirmationBarcode(generatedBarcode);
    }
...
/*
        ...
        if (isEdit) {
            ...
            if (finalButton) {
                finalButton.innerHTML =
                    ...
                    'Final Update';
                finalButton.className = 'btn btn-warning';
            }
            ...
            if (finalButton) {
                finalButton.innerHTML =
                    '<i class="bi bi-check-lg me-1"></i>' +
                    'Final Save';
                finalButton.className = 'btn btn-primary';
            }
        ...
        */
        ...
        if (!modalElement) {
            console.error('saveSpecificationPreviewModal element not found.');
            return;
        }
        ...
        |--------------------------------------------------------------------------
        | The modal can be rendered inside a page wrapper/sidebar stacking context.
        | Bootstrap then creates the backdrop correctly, but the modal itself can
        | remain behind that backdrop. Move this confirmation modal directly under
        | <body> before showing it so it always appears above the backdrop.
        |--------------------------------------------------------------------------
        */
    ...
    */
    ...
    async function loadUploadedImages() {
        ...
        try {
            ...
            const response =
                await fetch(
                    "{{ route('trader-specifications.uploaded-images') }}",
                    {
                        method: 'GET',
...
document.addEventListener(
            ...
            */
            ...
            showNewSpecification();
                ...
                function loadSpecifications(
                    ...
                    fetch(
                        "{{ route('trader-specifications.data') }}?" +
                        params.toString(),
                        {
                            method: 'GET',
                ...
                function displayMasterValue(name, code) {
                ...
                function createSpecificationCard(
                    ...
                    const designer = displayMasterValue(
                        specification.designer_name_text || specification.designer_name,
                        specification.designer_code_text || specification.designer_code
                    );


                    const itemType = displayMasterValue(
                        specification.item_type_text || specification.item_type,
                        specification.item_type_code_text || specification.item_type_code
                    );


                    const gender = displayMasterValue(
                        specification.gender_text || specification.gender,
                        specification.gender_code_text || specification.gender_code
                    );


                    const itemName = displayMasterValue(
                        specification.item_name_text || specification.item_name,
                        specification.item_name_code_text || specification.item_name_code
                    );


                    const composition = displayMasterValue(
                        specification.composition_text || specification.composition,
                        specification.composition_code_text || specification.composition_code
                    );


                    const colour = displayMasterValue(
                        specification.colour_text || specification.colour,
                        specification.colour_code_text || specification.colour_code
                    );


                    const size = displayMasterValue(
                        specification.size_text || specification.sizes,
                        specification.size_code_text || specification.size_code
                    );
                ...
                function openSpecificationView(
                    ...
                    */
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('item_name_text', value('item_name')),
                            value('item_name_code_text', value('item_name_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('designer_name_text', value('designer_name')),
                            value('designer_code_text', value('designer_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('item_type_text', value('item_type')),
                            value('item_type_code_text', value('item_type_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('gender_text', value('gender')),
                            value('gender_code_text', value('gender_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('composition_text', value('composition')),
                            value('composition_code_text', value('composition_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('yarn_text', value('yarn')),
                            value('yarn_code_text', value('yarn_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('colour_text', value('colour')),
                            value('colour_code_text', value('colour_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('size_text', value('sizes')),
                            value('size_code_text', value('size_code'))
                        );
                    ...
                    */
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('embellishment_text', value('embellishment')),
                            value('embellishment_code_text', value('embellishment_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('manufacturing_process_text', value('manufacturing_process')),
                            value('manufacturing_process_code_text', value('manufacturing_process_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('craftsman_text', value('craftsman')),
                            value('craftsman_code_text', value('craftsman_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('manufacture_text', value('manufecture')),
                            value('manufacture_code_text', value('manufacture_code'))
                        );
                    ...
                    document.getElementById(
                        ...
                        displayMasterValue(
                            value('client_text', value('client')),
                            value('client_code_text', value('client_code'))
                        );
    ...
    */
        ...
        */
        ...
        function editSpecification(
            ...
            */
            ...
            // Trader is a master select; restore by master ID, not by trader_name text.
            setSelectValue(
                'trader_id',
                specification.trader_id
            );

            setInputValue('trader_sku', specification.trader_sku);
            setInputValue('purchase_bill_no', specification.purchase_bill_no);
            setInputValue('purchase_date', specification.purchase_date);
            setInputValue('trader_quantity', specification.trader_quantity);
            setInputValue('trader_buying_price', specification.trader_buying_price);
            setInputValue('trader_selling_price', specification.trader_selling_price);
            setInputValue('trader_mrp', specification.trader_mrp);
            setInputValue('trader_min_selling_price', specification.trader_min_selling_price);
            setInputValue('trader_gst_percent', specification.trader_gst_percent);
            setInputValue('trader_discount', specification.trader_discount);
            setInputValue('trader_reference', specification.trader_reference);
    ...
    window.renderConfirmationImages = function () {
        ...
        const container =
            document.getElementById('confirmImages');
        ...
        function appendImage(target, fileOrUrl, altText) {
            if (!target || !fileOrUrl) {
                return;
            }
        ...
        // Existing database main/design images.
        if (
            typeof existingImages !== 'undefined' &&
            Array.isArray(existingImages) &&
            container
        ) {
            existingImages.forEach(function (imageUrl) {
                appendImage(container, imageUrl, 'Design Image');
            });
        }

        // Newly selected main/design images.
        const imageInput = document.getElementById('filenew');
        if (imageInput && imageInput.files && container) {
            Array.from(imageInput.files).forEach(function (file) {
                appendImage(container, file, 'New Design Image');
            });
        }

        // Retained sub images. These remain available even though the input
        // value is cleared after selection.
        if (
            subContainer &&
            typeof selectedSubImages !== 'undefined' &&
            Array.isArray(selectedSubImages)
        ) {
            selectedSubImages.forEach(function (file) {
                appendImage(subContainer, file, 'Sub Image');
            });
        }
        ...
        if (subContainer && !subContainer.children.length) {
            subContainer.innerHTML = `
                <div class="text-muted p-3">
        ...
        */
        ...
        async function loadMasterList() {
            ...
            try {
                ...
                const response =
                    await fetch(
                        `/admin/trader-specifications/master/${encodeURIComponent(currentMaster)}`,
                        {
                            method: 'GET',
                            headers: {
                                'Accept':
    ...
    filteredRows.forEach(function (row) {
        ...
        */
        ...
        if (row.code) {
            ...
            html += `
                    <small class="master-code-badge ms-2">
                        ${escapeHtml(row.code)}
                    </small>
            `;
        ...
        btnUpdate.addEventListener(
            ...
            async function () {
                ...
                try {
                    ...
                    const response =
                        await fetch(
                            `/admin/trader-specifications/master/${encodeURIComponent(currentMaster)}/${id}`,
                            {
                                method: 'PUT',
